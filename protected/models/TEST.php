...
class TEST extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('KHID, DWMQC, DWJC, SFCBS, XZKHBZ, JKBZ, PFBZ, YSK, YFK, KHSDBZ, KYBZ, CJRQ, ID, USERNAME, USERPASS', 'required'),
			array('XYDJ, ID', 'numerical', 'integerOnly'=>true),
