        ...
        <div class="search-form">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    ...
                    支持读书卡单ID模糊查询，卡ID范围（例:8880001-88800099）精确查询
                </div>
            </div>
            <div class="control-group">
            ...
            <div class="form-actions">
                <div style="margin-left: 97px;">
                    ...
                    <span style="margin-left: 30px;"><?php echo CHtml::button('导出Excel', array('class' => 'btn btn-success', 'id' => 'excel')); ?></span>&nbsp;注：无输入条件则导出全部记录
                </div>
            </div>
            <?php $this->endWidget(); ?>
        </div>
...
//            'filter' => $model,
                ...
                'columns' => array(
                    ...
                    array(
                        ...
                        'value' => function($data) {
                    $dis_data = ONESHOPGIFTCARDS::model()->addprefix($data->ID);
                    return $dis_data;
                },
                    ),
                    array(
