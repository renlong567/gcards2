...
<div class="container-fluid">
    <div class="widget-box">
        <div class="widget-title">
            ...
            <h5>基层店列表</h5>
            <div id="options">
                <a class="btn btn-success btn-mini" href="index.php?r=ONESHOPJCDJCXXB/create">添加新成员</a>
            </div>
        </div>
        <ul class="nav nav-tabs">
            <li class="active"><a data-toggle="tab" href="#tab0">所有基层店</a></li>
...
//                    'PHONE',
                    array(
                        'name' => '读书卡信息',
//                        'value' => '$data->giftcards',
                        'value' => '$data->contactsToString()',
//                        'value' => function($data) {
//            return (!empty($data->giftcards->attributes->id)) ? $data->giftcards['attributes']->id : '无';
//                }
//                                          'type' => 'html',
                    ),
//                                'sex' ,
